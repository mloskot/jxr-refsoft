...
#ifdef _MSC_VER
#pragma comment (user,"$Id: qp.tab.c,v 1.9 2011-11-08 20:17:29 thor Exp $")
#endif
...
{
       0,   136,   136,   139,   140,   147,   146,   198,   199,   200,
     204,   205,   210,   209,   217,   226,   237,   238,   242,   245,
     252,   262,   274,   280,   280,   283,   293
};
#endif
