...
* (1) in the ITU-T "T.JXR" | ISO/IEC 29199 ("JPEG XR") standard once
* the standard has been adopted; and (2) to develop the JPEG XR
* standard:
*
...
#ifdef _MSC_VER
#pragma comment (user,"$Id: w_tile_spatial.c,v 1.13 2011-04-28 08:45:43 thor Exp $")
#endif
...
* Revision 1.13  2011-04-28 08:45:43  thor
* Fixed compiler warnings, ported to gcc 4.4, removed obsolete files.
*
* Revision 1.12  2010-03-31 07:50:59  thor
